(function () {
    // page navigation controller - top menu
    ...
    app.config(['$routeProvider', function ($routeProvider) {
        $routeProvider.
        when('/Dashboard', {
            templateUrl: route + 'app/views/dashboard.html',
            controller: 'DashboardCtrl'
        })
        .when('/TicketCreate', {
            templateUrl: route + 'app/views/ticketCreate.html',
    ...
    function ($modal) {
        ...
        var modalDefaults = {
            ...
            keyboard: true,
            modalFade: true,
            templateUrl: route + 'app/partials/modal.html'
        };
    ...
    app.controller('TicketCreateCtrl', ['$scope', '$location', '$http', '$q', 'modalService', function ($scope, $location, $http, $q, modalService) {
        ...
        $scope.ticketCreate = function () {
            ...
            $http({
                ...
                //})
                //.then(function () {
                //    $scope.showDialogBox("Ticket number " + data.TicketNumber + " has been created.");
                //});
                //defer.resolve();
